...
TEST(EthRequestHelperUnitTest, CommonParseErrors) {
  ...
  for (const auto& error_case : error_cases) {
    ...
    EXPECT_FALSE(ParseEthDecryptParams(error_case, &message, &address));
  }
}
...
TEST(EthResponseHelperUnitTest, ParseEthDecryptParams) {
  ...
  std::string address;
  EXPECT_TRUE(ParseEthDecryptParams(json, &encrypted_message, &address));
  EXPECT_EQ(
      encrypted_message,
      "0x7b2276657273696f6e223a227832353531392d7873616c736132302d706f6c79313330"
      "35222c226e6f6e6365223a224f702f7353626241455474506d704c42337a493368643069"
      "3969486e62682f38222c22657068656d5075626c69634b6579223a22474e62315a4d6354"
      "36335235687962483034563344537551677137674d4d5937705a61354235546b66446f3d"
      "222c2263697068657274657874223a224b454a72325564686d4237663838514b7a6a4131"
      "51666a3650586932784f34357a3377766d673d3d227d");
  EXPECT_EQ(address, "0x9b2055d370f73ec7d8a03e965129118dc8f5bf83");

  EXPECT_TRUE(
      ParseEthDecryptParams(json_extra_entry, &encrypted_message, &address));
  EXPECT_EQ(
      encrypted_message,
      "0x7b2276657273696f6e223a227832353531392d7873616c736132302d706f6c79313330"
      "35222c226e6f6e6365223a224f702f7353626241455474506d704c42337a493368643069"
